  ...
  return (
    <>
      ...
      <main>
        ...
        <Paragraph text={"Nesse challenge buscamos melhorar o tempo de resposta que o atendente consegue devolver para o usuario, atraves de uma filtragem de chamados. Quantos mais casos resolvidos, mais chances de os problemas serem resolvidos em poucos minutos."} />
